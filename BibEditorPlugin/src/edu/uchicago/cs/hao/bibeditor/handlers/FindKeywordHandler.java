...
import edu.uchicago.cs.hao.bibeditor.dialogs.SearchDialog;
...
public class FindKeywordHandler extends BibHandler {
	 ...
	 * 
	 * @see
	 * edu.uchicago.cs.hao.bibeditor.handlers.BibHandler#executeWithEditor(org.
	 * eclipse.core.commands.ExecutionEvent,
	 * edu.uchicago.cs.hao.bibeditor.editors.BibEditor)
	 */
	@Override
